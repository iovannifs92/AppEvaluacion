...
public class datosConsumoSustanciasA {
    ...
    aconsume_cocaina, acantidad_cocaina,afrecuencia_cocaina,aultimo_consumo_cocaina,aconsumemas,aobservacionesfinales,afolio;
    ...
    public datosConsumoSustanciasA(int id, String aconsume_alcohol, String acantidad_alcohol, String afrecuencia_alcohol, String aultimo_consumo_alcohol, String aconsume_tabaco,
                                   ...
                                   String acantidad_cocaina, String afrecuencia_cocaina, String aultimo_consumo_cocaina, String aconsumemas,String aobservacionesfinales, String afolio) {
        this.id = id;
        ...
        this.aobservacionesfinales= aobservacionesfinales;
        this.afolio = afolio;
    }
    ...
    public String getAobservacionesfinales() { return aobservacionesfinales; }

    public void setAobservacionesfinales(String aobservacionesfinales) { this.aobservacionesfinales = aobservacionesfinales; }
