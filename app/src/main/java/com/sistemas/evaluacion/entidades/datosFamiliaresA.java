...
public class datosFamiliaresA {
    int id;
    String apersonasreferencias,aviveconel,anombre1,arelacion1,aedad1,atelefono1,avivecon1,anombre2,arelacion2,aedad2,
            atelefono2,avivecon2,aubicarfam,anombrefam,arelacionfam,alocalidadfam,afolio;

    public datosFamiliaresA(int id, String apersonasreferencias, String aviveconel, String anombre1, String arelacion1, String aedad1, String atelefono1, String avivecon1,
...
//region get-set
    ...
    public String getAviveconel() { return aviveconel; }

    public void setAviveconel(String aviveconel) { this.aviveconel = aviveconel; }
