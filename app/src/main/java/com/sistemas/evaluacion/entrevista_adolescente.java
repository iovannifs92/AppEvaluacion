...
public class  entrevista_adolescente extends AppCompatActivity {
    ...
    //region EditText
    //datos generales
    private EditText txtNc, txtFecha, txtNe,txtNpa1, txtNpa2, txtNpa3, txtNpa4, txtRa1, txtRa2, txtRa3, txtRa4, txtPOa3, txtPOa4,txtApeP,txtApeM,txtNa, txtEa, txtFNa, txtCURPa, txtEDOa, txtMa, txtLa, txtNAa ;
    ...
    private String r1A,r2A,r3A,FOLIOA,r5A,r6A,r7A,r8A,r9A,r10A,r11A,r13A,r14A,r17A,r17A_1,r17A_2,r18A,r19A,r20A,r22A,r23A,r24A,
            ...
            r99A,r100A;
    //SPINNERS
    private String rS1,rS2,rS3,rS4,rS5,rS6,rS7,rS8,rS9,rS9_1,rS9_2,rS10,rS11,rS12,rS13,rS14,rS15,rS16,rS17,rS18,rS19,rS20,rS21,rS22,rS23,rS24,rS25,rS26,rS27,
            rS28,rS29,rS30,rS31,rS32,rS33,rS34,rS35,rS36,rS37,rS38,rS39,rS40,rS41,rS42,rS42_1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //endregion
        // region  Relacion Participante oyente 1
        sPRa1 = (Spinner) findViewById(R.id.sPRa1);
        sPRa1.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, tipoR));
        //endregion
        // region Relacion Participante oyente 2
        sPRa2 = (Spinner) findViewById(R.id.sPRa2);
        sPRa2.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, tipoR));
        //endregion
        ...
        sPVDF1 = (Spinner) findViewById(R.id.sPVDF1);
        sPVDF1.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        // region sPVDF vive con el 2
        sPVDF2 = (Spinner) findViewById(R.id.sPVDF2);
        sPVDF2.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        ...
        sPAR1.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        // region sPAR  ADOLECENTE RESPONSABLE2
        sPAR2 = (Spinner) findViewById(R.id.sPAR2);
        sPAR2.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        // region sPAR  ADOLECENTE RESPONSABLE3
        sPAR3 = (Spinner) findViewById(R.id.sPAR3);
        sPAR3.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        ...
        sPEE.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        // region sPEM  ES MADRE
        sPEM = (Spinner) findViewById(R.id.sPEM);
        sPEM.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        //endregion
        // region sPC  CUAL?
        ...
        sPPe.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, nosia));
        ...
        btnGuardarA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rS42_1=sPPe.getSelectedItem().toString().toUpperCase();
                ...
                rS9_2=sPDE.getSelectedItem().toString().toUpperCase();
                ...
                db.insertarDatosGeneralesA(r17A_1,r17A_2,r17A,rS2,r18A,r19A,r20A,r22A,r23A,r24A,r25A,rS4,rS3,FOLIOA,"NO","NO");
                db.insertarDatosFichaFamiliarA(r26A,r27A,r28A,r28_1A,r29A,r30A,r31A,r32A,r33A,rS5,rS8,r34A,r7A,r35A,r8A,r36A,r11A,FOLIOA);
                db.insertarDatosFamiliaresA(rS42,rS42_1,r38A,r40A,r42A,r44A,rS6,r39A,r41A,r43A,r45A,rS7,rS9,r46A,r47A,r48A,FOLIOA);
                db.insertarDatosDependientesEconomicosA(rS9_1,rS9_2,r49A,r52A,r55A,r58A,rS10,r50A,r53A,r56A,r59A,rS11,r51A,r54A,r57A,r60A,rS12,FOLIOA);
